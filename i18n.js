    ...
    const translations = {
        en: {
            ...
            home: {
                ...
                seoIntroTitle: 'What is an AI chart analysis tool?',
                seoIntroText: 'ChartAnalyze helps you review chart flow with AI. By checking daily, hourly, and minute charts together, you can organize trend direction and market structure more clearly.',
                seoMtfTitle: 'What is multi-timeframe analysis?',
                seoMtfText: 'Multi-timeframe analysis combines multiple chart intervals to understand the market. You can review the broader flow on the daily chart and compare shorter-term movement on hourly and minute charts.',
                seoHowTitle: 'How to use',
                seoHowStep1: 'Upload daily, hourly, and minute chart screenshots',
                seoHowStep2: 'AI analyzes trend flow and market structure',
                seoHowStep3: 'Review the analysis as reference information',
