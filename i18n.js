    ...
    const translations = {
        en: {
            ...
            home: {
                ...
                seoFeature4: 'Useful for reviewing crypto and stock charts',
                seoAudienceTitle: 'Who this is for',
                seoAudienceText: 'This tool is designed for crypto traders, stock investors, and anyone who reviews charts as part of their market analysis.',
            ...
            analysis: {
                ...
                overallPending: 'Waiting for combined result',
                overallPendingDescription: 'The combined flow will appear after chart analysis is complete.',
                overallUp: 'Uptrend Bias',
                overallDown: 'Downtrend Bias',
                overallSideways: 'Sideways Bias',
                overallMixed: 'Mixed Flow',
                overallInsufficient: 'Not enough data',
                overallUpDescription: 'Across the uploaded timeframes, upward flow appears more frequently.',
                overallDownDescription: 'Across the uploaded timeframes, downward flow appears more frequently.',
                overallSidewaysDescription: 'Across the uploaded timeframes, sideways movement appears more frequently.',
                overallMixedDescription: 'The uploaded timeframes show mixed flow without one clear dominant direction.',
                overallInsufficientDescription: 'There is not enough analyzed chart data to summarize the combined flow.',
                overallCount: 'Up {up} · Sideways {sideways} · Down {down}',
            },
            footer: {
        ...
        ko: {
            ...
            home: {
                ...
                seoFeature4: '가상자산 및 주식 차트 확인에 활용 가능',
                seoAudienceTitle: '대상 사용자',
                seoAudienceText: '이 도구는 가상자산 트레이더, 주식 투자자 등 차트 분석을 하는 모든 사용자를 위해 설계되었습니다.',
            ...
            analysis: {
                ...
                overallTitle: '종합분석',
                overallPending: '종합 결과 대기',
                overallPendingDescription: '차트 분석이 완료되면 시간대별 결과를 종합해 표시합니다.',
                overallUp: '상승 우세',
                overallDown: '하강 우세',
                overallSideways: '횡보 우세',
                overallMixed: '혼조',
                overallInsufficient: '데이터 부족',
                overallUpDescription: '업로드된 시간대 차트 전반에서 상승 흐름이 더 많이 관찰됩니다.',
                overallDownDescription: '업로드된 시간대 차트 전반에서 하강 흐름이 더 많이 관찰됩니다.',
                overallSidewaysDescription: '업로드된 시간대 차트 전반에서 횡보 흐름이 더 많이 관찰됩니다.',
                overallMixedDescription: '업로드된 시간대 차트의 흐름이 엇갈려 뚜렷한 한 방향이 우세하지 않습니다.',
                overallInsufficientDescription: '종합 흐름을 표시하기에 분석된 차트 데이터가 충분하지 않습니다.',
                overallCount: '상승 {up} · 횡보 {sideways} · 하강 {down}',
            },
            footer: {
        ...
        ja: {
            ...
            home: {
                ...
                seoFeature4: '仮想通貨・株式などのチャート確認に対応',
                seoAudienceTitle: '対象ユーザー',
                seoAudienceText: 'このツールは、仮想通貨トレーダー、株式投資家など、チャート分析を行うすべてのユーザー向けに設計されています。',
            ...
            analysis: {
                ...
                overallTitle: '総合分析',
                overallPending: '総合結果を待機中',
                overallPendingDescription: 'チャート分析が完了すると、時間軸ごとの結果をまとめて表示します。',
                overallUp: '上昇優勢',
                overallDown: '下落優勢',
                overallSideways: '横ばい優勢',
                overallMixed: '混在',
                overallInsufficient: 'データ不足',
                overallUpDescription: 'アップロードされた時間軸全体では、上昇方向の流れが比較的多く見られます。',
                overallDownDescription: 'アップロードされた時間軸全体では、下落方向の流れが比較的多く見られます。',
                overallSidewaysDescription: 'アップロードされた時間軸全体では、横ばいの流れが比較的多く見られます。',
                overallMixedDescription: 'アップロードされた時間軸の流れが分かれており、明確に優勢な方向は見られません。',
                overallInsufficientDescription: '総合的な流れを表示するための分析済みチャートデータが不足しています。',
                overallCount: '上昇 {up} · 横ばい {sideways} · 下落 {down}',
            },
            footer: {
